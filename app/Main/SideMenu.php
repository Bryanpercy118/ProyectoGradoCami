...
class SideMenu
{
    ...
    public static function menu()
    {
        ...
        $menuSuperAdmin = [
            ...
            'point-of-sale' => [
                'icon' => 'credit-card',
                'route_name' => 'preinscripciones',
                'params' => [
                    'layout' => 'side-menu'
                ],
                'title' => 'Gestion de PreInscripciones'
            ],
            'periodos' => [
                'icon' => 'credit-card',
                'route_name' => 'periodos',
        ...
        $menuDocente = [
            'inbox' => [
                'icon' => 'inbox',
                'route_name' => 'docente.notas.index',
                'params' => [
                    'layout' => 'side-menu'
                ],
        ...
        $menuAlumno = [
             'dashboard' => [
                'icon' => 'home',
                'title' => 'Dashboard_alumno',
                'route_name' => 'alumno.dashboard',
                'params' => [
                    'layout' => 'side-menu',
                ],
                'title' => 'Dashboard_alumno'
            ...
            'point-of-sale' => [
                'icon' => 'credit-card',
                'route_name' => 'meddocs.index',
                'params' => [
                    'layout' => 'side-menu'
                ],
                'title' => 'Gestion de Documentos Medicos'
            ],
            // 'chat' => [
            //     'icon' => 'message-square',
            //     'route_name' => 'chat',
        ...
        return match ($role) {
            'administrador' => $menuSuperAdmin ,
            'profesor' => $menuDocente,
            'estudiante' =>  $menuAlumno,
            default => [],
        };
        // return [
        //     'dashboard' => [
