...
use App\Models\{Salon, Subject, Preinscripcion, Periodo};
...
class PageController extends Controller
{
    ...
    public function fileManager()
    {
        ...
        return view('pages.asignaturas', compact('asignaturas'));
    }
    ...
    {
       $salones = Salon::all();
       return view('pages.salones', compact('salones'));
    }

    public function preinscripciones()
    {
        $preinscripciones = \App\Models\Preinscripcion::withCount('aspirantes')
            ->withSum('cupos', 'cupo_total')
            ->get()
            ->map(function ($p) {
                $p->total_cupos  = (int) ($p->cupos_sum_cupo_total ?? 0);
                $p->disponibles  = max(0, $p->total_cupos - (int) $p->aspirantes_count);
                return $p;
            });

        return view('pages.preinscripciones', compact('preinscripciones'));
    }
    ...
    public function periodos()
    {
        ...
        return view('pages.periodos', compact('periodos'));
    }
    ...
    public function asignaciones()
    {
        ...
        $salones = Salon::all();
        $year = now()->year;
        return view('pages/asignaciones', compact(
            'asignaciones',
            'docentes',
            'subjects',
            'salones',
    ...
    {
        return view('pages/matriculas.index');
    }
